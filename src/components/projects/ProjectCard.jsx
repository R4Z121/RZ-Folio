    ...
    <div className="p-3 gap-3 flex flex-col justify-between bg-app-red lg:max-w-md rounded">
      <div className="flex flex-col gap-3">
        <div className="flex justify-between gap-3 items-center">
          <p className="text-sm xs:text-base font-bold overflow-hidden text-ellipsis whitespace-nowrap">{data.title}</p>
        ...
        <div className="flex flex-col p-1 gap-7">
          <p className="text-xs xs:text-sm text-justify">{data.desc}</p>
        </div>
      </div>
      <div className="flex flex-col p-1 gap-7">
